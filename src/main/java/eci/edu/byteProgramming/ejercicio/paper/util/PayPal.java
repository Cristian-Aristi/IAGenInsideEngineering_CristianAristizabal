...
/**
 * Implementación concreta de PaymentMethod para PayPal
 * 
 * Maneja la validación y procesamiento de pagos mediante PayPal.
 * Propiedades específicas: email, token de autenticación.
 */
public class PayPal extends PaymentMethod {
    ...
    public PayPal(double amount, String customerId, String description,
